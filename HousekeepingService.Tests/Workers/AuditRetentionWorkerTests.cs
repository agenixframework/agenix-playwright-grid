...
public class AuditRetentionWorkerTests
{
    ...
    private Mock<ILogger<AuditRetentionWorker>> _loggerMock;
    private ChunkedLogger<AuditRetentionWorker> _chunkedLogger;
    private AuditRetentionWorker _worker;
    ...
    public void SetUp()
    {
        ...
        _loggerMock = new Mock<ILogger<AuditRetentionWorker>>();
        _chunkedLogger = new ChunkedLogger<AuditRetentionWorker>(_loggerMock.Object);

        _worker = new AuditRetentionWorker(
            _configMock.Object,
    ...
    public async Task ExecuteAsync_ShouldProcessProjects()
    {
        ...
        _configMock.Setup(x => x["AGENIX_HOUSEKEEPING_AUDIT_RETENTION_CHECK_INTERVAL_HOURS"]).Returns("1");
        ...
        _settingsReaderMock.Setup(x => x.GetRetentionSettingsAsync("p1"))
                           .ReturnsAsync(new RetentionSettings { ProjectKey = "p1", KeepLaunchesDays = 30, KeepLogsDays = 7, KeepAttachmentsDays = 7, KeepAuditDays = 90 });
        ...
        _loggerMock.Verify(
            x => x.Log(
                ...
                It.IsAny<EventId>(),
                It.Is<It.IsAnyType>((v, t) => v.ToString()!.Contains("Starting audit retention check")),
                null,
