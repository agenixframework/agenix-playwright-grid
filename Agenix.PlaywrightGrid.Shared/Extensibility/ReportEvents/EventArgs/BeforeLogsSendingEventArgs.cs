...
public class BeforeLogsSendingEventArgs(IClientService clientService,
    IConfiguration configuration,
    IList<CreateLogItemRequest> createLogItemRequests) : ReportEventBaseArgs(clientService, configuration)
{

    /// <summary>
    ///     Gets the list of create log item requests.
    /// </summary>
    public IList<CreateLogItemRequest> CreateLogItemRequests { get; } = createLogItemRequests;
}
