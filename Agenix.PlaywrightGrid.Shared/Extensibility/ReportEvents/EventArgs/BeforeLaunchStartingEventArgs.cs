...
public class BeforeLaunchStartingEventArgs(IClientService clientService, IConfiguration configuration,
    StartLaunchRequest startLaunchRequest) : ReportEventBaseArgs(clientService, configuration)
{

    /// <summary>
    ///     Gets the start launch request.
    /// </summary>
    public StartLaunchRequest StartLaunchRequest { get; } = startLaunchRequest;
}
