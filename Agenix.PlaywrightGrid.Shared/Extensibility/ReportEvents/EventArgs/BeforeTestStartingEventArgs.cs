...
public class BeforeTestStartingEventArgs(IClientService clientService, IConfiguration configuration,
    StartTestItemRequest startTestItemRequest) : ReportEventBaseArgs(clientService, configuration)
{

    /// <summary>
    ///     Gets the start test item request.
    /// </summary>
    public StartTestItemRequest StartTestItemRequest { get; } = startTestItemRequest;
}
