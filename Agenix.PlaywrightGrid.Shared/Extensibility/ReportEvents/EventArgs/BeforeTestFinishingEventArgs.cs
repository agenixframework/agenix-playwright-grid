...
public class BeforeTestFinishingEventArgs(IClientService clientService, IConfiguration configuration,
    FinishTestItemRequest finishTestItemRequest) : ReportEventBaseArgs(clientService, configuration)
{

    /// <summary>
    ///     Gets the finish test item request.
    /// </summary>
    public FinishTestItemRequest FinishTestItemRequest { get; } = finishTestItemRequest;
}
