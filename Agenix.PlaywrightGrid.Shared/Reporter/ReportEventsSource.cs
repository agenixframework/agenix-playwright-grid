...
{
    private static readonly ITraceLogger _traceLogger = TraceLogManager.Instance.GetLogger<ReportEventsSource>();
    ...
    public static void RaiseLaunchInitializing(ReportEventsSource source, ILaunchReporter launchReporter,
    ...
    /// <param name="launchReporter">The launch reporter.</param>
    /// <param name="args">The event arguments.</param>
    public static void RaiseBeforeLaunchStarting(ReportEventsSource source, ILaunchReporter launchReporter,
    ...
    /// <param name="launchReporter">The launch reporter.</param>
    /// <param name="args">The event arguments.</param>
    public static void RaiseAfterLaunchStarted(ReportEventsSource source, ILaunchReporter launchReporter,
        AfterLaunchStartedEventArgs args)
    {
    ...
    /// <param name="launchReporter">The launch reporter.</param>
    /// <param name="args">The event arguments.</param>
    public static void RaiseBeforeLaunchFinishing(ReportEventsSource source, ILaunchReporter launchReporter,
    ...
    /// <param name="launchReporter">The launch reporter.</param>
    /// <param name="args">The event arguments.</param>
    public static void RaiseAfterLaunchFinished(ReportEventsSource source, ILaunchReporter launchReporter,
    ...
    /// <param name="args">The event arguments.</param>
    public static void RaiseBeforeTestStarting(ReportEventsSource source, ITestReporter testReporter,
        BeforeTestStartingEventArgs args)
    {
    ...
    /// <param name="testReporter">The test reporter.</param>
    /// <param name="args">The event arguments.</param>
    public static void RaiseAfterTestStarted(ReportEventsSource source, ITestReporter testReporter,
        AfterTestStartedEventArgs args)
    {
    ...
    /// <param name="testReporter">The test reporter.</param>
    /// <param name="args">The event arguments.</param>
    public static void RaiseBeforeTestFinishing(ReportEventsSource source, ITestReporter testReporter,
        BeforeTestFinishingEventArgs args)
    {
    ...
    /// <param name="testReporter">The test reporter.</param>
    /// <param name="args">The event arguments.</param>
    public static void RaiseAfterTestFinished(ReportEventsSource source, ITestReporter testReporter,
        AfterTestFinishedEventArgs args)
    {
    ...
    /// <param name="args">The event arguments.</param>
    public static void RaiseBeforeLogsSending(ReportEventsSource source, ILogsReporter logsReporter,
        BeforeLogsSendingEventArgs args)
    {
    ...
    /// <param name="logsReporter">The logs reporter.</param>
    /// <param name="args">The event arguments.</param>
    public static void RaiseAfterLogsSent(ReportEventsSource source, ILogsReporter logsReporter,
        AfterLogsSentEventArgs args)
    {
        ...
        if (handlers != null)
        {
            foreach (var handler in handlers)
            {
                ...
                catch (Exception ex)
                {
                    _traceLogger.Error(
                        new Exception(
                            $"Unhandled error occurred in handler '{handler.Method}' for one of the reporting event.",
                            ex).ToString());
                }
            }
        }
