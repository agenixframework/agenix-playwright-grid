...
internal class TestMetadataEmitter(ITestContext testContext, TestCommandsSource commandsSource) : ITestMetadataEmitter
{
    private readonly TestCommandsSource _commandsSource = commandsSource;
