...
/// <summary>
///     Creates instances of <see cref="IRequestExecutor" /> based on <see cref="IConfiguration" />
/// </summary>
public interface IRequestExecutorFactory
{
    ...
    /// </summary>
    /// <returns>An instance of <see cref="IRequestExecutor" /></returns>
    IRequestExecutor Create();
}
