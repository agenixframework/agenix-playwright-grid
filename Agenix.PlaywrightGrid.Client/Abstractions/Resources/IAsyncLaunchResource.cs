...
/// <summary>
///     Async interface for launch operations.
/// </summary>
public interface IAsyncLaunchResource
{
    /// <summary>
    ///     Finishes a launch by its UUID.
    /// </summary>
    Task<LaunchFinishedResponse> FinishAsync(
        string uuid,
    ...
    /// <summary>
    ///     Merges multiple launches.
    /// </summary>
    Task<LaunchResponse> MergeAsync(
        MergeLaunchesRequest request,
        CancellationToken cancellationToken = default
    );
    ...
    ///     Starts a new launch.
    /// </summary>
    Task<LaunchCreatedResponse> StartAsync(
