...
/// <summary>
///     Interacts with project resources.
/// </summary>
public interface IProjectResource
{
    ...
    /// <summary>
    ///     Updates user preferences for the project.
    /// </summary>
    Task<MessageResponse> UpdatePreferencesAsync(string username, PreferenceRequest preferences,
        CancellationToken cancellationToken = default);

    /// <summary>
    ///     Gets all user preferences.
    /// </summary>
    Task<PreferenceResponse> GetAllPreferencesAsync(string username, CancellationToken cancellationToken = default);
}
