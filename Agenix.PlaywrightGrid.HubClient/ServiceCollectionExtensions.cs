...
public static class ServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddHubClient(this IServiceCollection services, Action<HubClientOptions> configure)
    {
        ...
        var secret = (opts.RunnerSecret ?? Environment.GetEnvironmentVariable("HUB_RUNNER_SECRET") ?? "runner-secret")
            .Trim();
        ...
        string? runnerSecret = null, TimeSpan? timeout = null)
    {
        ...
        return services.AddHubClient(o =>
        {
            o.HubUrl = hubUrl;
            o.RunnerSecret = runnerSecret;
            o.Timeout = timeout;
        });
    }
