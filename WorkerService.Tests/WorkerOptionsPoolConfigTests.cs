...
public class WorkerOptionsPoolConfigTests
{
    ...
    {
        var prev = Environment.GetEnvironmentVariable("POOL_CONFIG");
        try
        {
            Environment.SetEnvironmentVariable("POOL_CONFIG", "  AppA:Chromium:UAT = 2 , X = 1 , AppB:Firefox:UAT= 5  ");
        ...
        {
            Environment.SetEnvironmentVariable("POOL_CONFIG", prev);
        }
    }
    ...
    public void Duplicate_Keys_Last_Wins()
    {
        ...
        try
        {
            Environment.SetEnvironmentVariable("POOL_CONFIG", "AppA:Chromium:UAT=1,AppA:Chromium:UAT=3");
            var opts = WorkerOptions.FromEnvironment();
    ...
    public void Empty_Or_Invalid_Entries_Fall_Back_To_Default()
    {
        ...
        try
        {
            ...
            Environment.SetEnvironmentVariable("POOL_CONFIG", " , ,  ");
            var opts = WorkerOptions.FromEnvironment();
    ...
    public void Normalization_Retains_Original_Case_By_Default()
    {
        ...
        try
        {
            ...
            Environment.SetEnvironmentVariable("POOL_CONFIG", "appA:Chromium:UAT=2");
            var opts = WorkerOptions.FromEnvironment();
